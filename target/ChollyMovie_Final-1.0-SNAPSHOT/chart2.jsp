...
<%@page import="beans.ReservasPelicula, dao.Negocio" %>
<html>
    <head>
    ...
    <body>
        ...
        <%
            ...
            String label = "";
            String data = "";
            String color = "['orange','lightblue','lightred','lightgreen','red', 'yellow', 'gray','blue', 'beige', 'brown', 'purple']";
            List<ReservasPelicula> a = obj.lisReservasTotalesPorPelicula(an);

            if (!a.isEmpty()) {
                for (ReservasPelicula x : a) {
                    label += "'" + x.getPelicula() + "',";
